 ...
 * 
 * We have provided the abstract Book class and a Main class. In the Main class, we created an
 * instance of a class called MyBook. Your task is to write just the MyBook class.Your class
 * mustn't be public.
 * 
 * @author Unai de la O
 */
